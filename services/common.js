...
exports.sendMail = async function ({ to, subject, text, html }) {
  let info = await transporter.sendMail({
    from: '"E-commerce" <makwepbynew@gmail.com>', // sender address
    to,
    subject,
    text,
    html,
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            <tr>
              <td align="center" valign="top" style="padding: 36px 24px;">
                <a href="https://mern-ecommerce-two-taupe.vercel.app/" target="_blank" style="display: inline-block;">
                  <img src="https://mern-ecommerce-two-taupe.vercel.app/logo-login.png" alt="Logo" border="0" width="120" style="display: block; width: 120px; max-width: 120px; min-width: 120px;">
                </a>
              </td>
            </tr>
          </table>
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            ...
            <tr>
              <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                <p style="margin: 0;">Here is a summary of your recent order. If you have any questions or concerns about your order, please <a href="makewepbynew@gmail.com">contact us</a>.</p>
              </td>
            </tr>
            <!-- end copy -->
